...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.rectangle(frame, (x, y), (x+w, y+h), emotion_colors[emotion_index], 1)
        
        cv2.putText(frame, emotion, (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 1, emotion_colors[emotion_index], 1)
